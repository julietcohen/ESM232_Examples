...
both_p = both %>% gather(key="model", value="P", -year) # same as pivot longer, just old function
...
# this function integrates the input diff eqn for each point in time or space
# this is best utilized for complex diff eqns with 1 changing param (time or space) but it is always preferred to integrate by hand because that way is more analytically correct
```
...
# df of times to plug into the function 

# create a new col called Panalytic
